...
sudo /usr/local/NVIDIA-Nsight-Compute-2022.1/ncu -f --target-processes all --set full --log-file blort.log ./mmpy -v -n 2048

# You may use "--section <section-name>" instead of "--set full". Available sections are listed at the end of this file.
sudo /usr/local/NVIDIA-Nsight-Compute-2022.1/ncu -f --target-processes all --section ComputeWorkloadAnalysis --log-file blort.log ./mmpy -v -n 2048
...
sudo /usr/local/NVIDIA-Nsight-Compute-2022.1/ncu -f -o profile --target-processes all --set full --log-file blort.log ./mmpy -v -n 2048
sudo /usr/local/NVIDIA-Nsight-Compute-2022.1/ncu -f -o profile --target-processes all --section ComputeWorkloadAnalysis --log-file blort.log ./mmpy -v -n 2048
